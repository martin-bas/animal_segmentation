...
def get_coordinates(im, message):
    ...
    FONT_THICKNESS = 2
    if message == 'arena':
        message = 'draw the rectangle of the arena clicking the mouse and them press Enter to finish'
    else:
        message = 'draw the rectangle of the nest clicking the mouse and them press Enter to finish'
